...
contract BasicTokenWithTransferAndDepositFees is ERC20Basic {
  ...
  * deposit_fee_rate: default to 165 which equals 165 / 
  */
...
/**
 * PGX Token, "Pecunio Gold Token"
 * Features:
 *  - ERC20 compliant
 *  - Lock-Up with variable time/amount (owner only)
 *  - Burn with variable amount (anyone)
 */
contract PGX is StandardToken, Ownable { 
    
    event Burn(address indexed burner, uint256 value);
    
    // Public variables of the token
    string public constant symbol = "PGX";
    string public constant name =  "Pecunio Gold Token";
    
    uint8 public constant decimals = 8;
    
    // 25.000.000 tokens + 8 DECIMALS = 25 * 10^14 units 
    uint256 public constant INITIAL_SUPPLY = 2500000000000000;
